 ...
 * 
 * @see com.sunrise.robotdigger.hibernate.Uploadfile
 * @author MyEclipse Persistence Tools
 */

public class UploadfileDAO extends HibernateDaoSupport {
	private static final Logger log = LoggerFactory
			.getLogger(UploadfileDAO.class);
	// property constants
	...
	public Uploadfile findById(java.lang.String id) {
		log.debug("getting Uploadfile instance with id: " + id);
		try {
			Uploadfile instance = (Uploadfile) getHibernateTemplate().get(
					"com.sunrise.robotdigger.hibernate.Uploadfile", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Uploadfile instance) {
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Uploadfile instance with property: " + propertyName
				+ ", value: " + value);
		try {
			String queryString = "from Uploadfile as model where model."
					+ propertyName + "= ?";
	...
	public List findAll() {
		log.debug("finding all Uploadfile instances");
		try {
			String queryString = "from Uploadfile";
	...
	public Uploadfile merge(Uploadfile detachedInstance) {
		...
		try {
			Uploadfile result = (Uploadfile) getHibernateTemplate().merge(
					detachedInstance);
	...
	public static UploadfileDAO getFromApplicationContext(ApplicationContext ctx) {
		return (UploadfileDAO) ctx.getBean("UploadfileDAO");
	}
}